                               ...
                               <div class="gallery">
                                  ...
                                  <div class="xzoom-thumbs">
                                   @foreach($item->galleries as $gallery)
                                       <a href="{{Storage::url($gallery->image)}}" class="xzoom-gallery">
                                        <img src="{{Storage::url($gallery->image)}}" alt="" width="128" xpreview="{{Storage::url($gallery->image)}}"/>
                                      </a>   
                                   @endforeach
                                  </div>
                               </div>
                       ...
                       <div class="col-lg-4">
                         <div class="card card-details card-right">
                           ...
                           <div class="members my-2">
                              <img src="frontend/images/members/Mask Group 3.png" alt="" class="member-image mr-1">
                              <img src="frontend/images/members/Mask Group 3.png" alt="" class="member-image mr-1">
                              <img src="frontend/images/members/9+@2x.png" alt="" class="member-image mr-1">
                           </div>
                            <hr>
                            <h2>Trip Informatioon</h2>

                          <table class="trip-information">
                            <tr>
                              <th width=50%>Date Of Departure
                              </th>
                              <td width="50%" class="text-right">{{\Carbon\Carbon::create($item->date_of_departure)->format('F n, Y')}}</td>
                            </tr>

                            <tr>
                              <th width=50%>Duration
                              </th>
