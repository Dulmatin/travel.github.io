                           ...
                           @if($errors->any())
                                         ...
                                         {{\Carbon\Carbon::createFromDate($detail->doe_passport) > \Carbon\Carbon::now() ? 'Active' : 'Inactive'}}
                                           ...
                                           <td class="align-middle">
                                             <a href="{{ route('checkout-remove',$detail->id) }}">
                                                 <img src="{{url('frontend/images/members/ic_remove.png')}}" alt="">
                                             </a>
                                         </td>
                                        </tr>
                            ...
                            <div class="members mt-3">
                                ...
                                @csrf
                                    ...
                                    <input type="text" name="username" class="form-control mb-2 mr-sm-2" id="user" placeholder="Username" required>

                                    <label for="nationality" class="sr-only">Nationality</label>
                                    <input type="text" name="nationality" class="form-control mb-2 mr-sm-2" id="inputNationality" placeholder="Nationality" style="width:50px;" required>

                                    <label for="is_visa" class="sr-only">Visa</label>
                                    <select name="is_visa" class="custom-select mb-2 mr-sm-2" id="inputVisa" required>
                                    ...
                                    <input type="text" name="doe_passport" class="form-control datepicker" id="doePassport" placeholder="DOE Passport" required>
                                </div>
